...
import { Transaction as CsvTransaction } from '@/utils/csv-parser';
import { applyRules, defaultRules } from '@/utils/categorization';
import { extractCategoriesFromTransactions } from '@/utils/categories';
import { stringEquals, stringIncludes } from '@/utils/stringUtils';
import { AppEvents, emitEvent } from '@/utils/events';
import { calculateMonthEndProjection } from '@/utils/insights/projection';

// Composants
import { LeftPanelInsights } from '@/components/transactions/insights/LeftPanelInsights';
import { RightPanelDetails } from '@/components/transactions/RightPanelDetails';
import { CommandBarNew } from '@/components/transactions/CommandBar';
import { TransactionImport } from '@/components/transactions/modals/ImportModal';
import { TransactionFormDialog } from '@/components/transactions/modals/TransactionFormDialog';
import { SplitTransactionDialog } from '@/components/transactions/modals/SplitTransactionDialog';
import { TransactionTable } from '@/components/transactions/view/TransactionTable';
import { PaginationControls } from '@/components/transactions/components/PaginationControls';
