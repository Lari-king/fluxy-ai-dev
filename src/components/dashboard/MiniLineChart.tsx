...
import { Card, CardContent } from '@/components/ui/card'; // Assumer que ces composants shadcn/ui sont disponibles
import { formatCurrency } from '@/utils/format'; // Assumer que ce chemin est correct
