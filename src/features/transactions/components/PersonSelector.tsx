/**
 * 👤 PERSON SELECTOR
 * Sélecteur de personne avec recherche
 */
      ...
      <div className="w-full flex items-center justify-between gap-3 px-4 py-2.5 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
        ...
        >
          {selectedPerson ? (
            <>
              <Avatar
                className="w-8 h-8 ring-2 ring-offset-1"
                style={{ '--tw-ring-color': selectedPerson.color } as React.CSSProperties}
              >
            ...
            <div className="max-h-64 overflow-y-auto">
              ...
              {filteredPeople.length > 0 ? (
                filteredPeople.map((person) => (
                  ...
                  >
                    <Avatar
                      className="w-10 h-10 ring-2 ring-offset-1"
                      style={{ '--tw-ring-color': person.color } as React.CSSProperties}
                    >
                    ...
                    <div className="flex-1 text-left min-w-0">
                      ...
                      <div className="text-xs text-gray-500 truncate flex items-center gap-2">
                        ...
                        <Badge variant="outline" className="text-xs py-0 px-1.5">
                          {person.circle === 'direct'
                            ? 'Directe'
                            : person.circle === 'extended'
                            ? 'Élargie'
                            : 'Grande'}
                        </Badge>
                      </div>
