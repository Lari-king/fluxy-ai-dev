...
import type { GeneratedInsight } from '@/features/ultra-intelligence/services/insights-generator';
...
export function InsightCard({ insight, index }: InsightCardProps) {
  ...
  // ✅ SÉCURITÉ : Si la sévérité n'est pas reconnue, on bascule sur 'info' par défaut
