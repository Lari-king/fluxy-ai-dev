    ...
    >
      ...
      >
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="name" className="flex items-center gap-2">
                <Tag className="w-4 h-4" /> Nom de l'actif
              </Label>
              <Input
                id="name"
                value={formData.name}
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition-all"
              >
                {categories.map(cat => (
            ...
            <div className="space-y-2">
              <Label htmlFor="value" className="flex items-center gap-2">
                <DollarSign className="w-4 h-4" /> Valeur actuelle (€)
              </Label>
              <Input
                id="value"
                type="number"
                  ...
                  <button
                    ...
                    className={`w-10 h-10 rounded-xl border-4 transition-all hover:scale-110 ${
                      formData.color === color.value
                        ? 'border-white dark:border-gray-900 shadow-xl ring-2 ring-indigo-500'
                        : 'border-transparent'
                    }`}
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 p-6 bg-gray-50 dark:bg-gray-800/50 flex justify-end gap-3">
          ...
          <Button onClick={handleSubmit} className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700">
