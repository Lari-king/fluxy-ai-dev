...
import { Card, CardContent, CardHeader, CardTitle } from '../ui/card'; // Chemin ajusté
import { AlertCircle, CheckCircle, Calendar, TrendingUp, HelpCircle, Scissors } from 'lucide-react';
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '../ui/tooltip'; // Chemin ajusté
import { Slider } from '../ui/slider'; // Chemin ajusté
import { Badge } from '../ui/badge'; // Chemin ajusté
import { Button } from '../ui/button'; // Chemin ajusté
